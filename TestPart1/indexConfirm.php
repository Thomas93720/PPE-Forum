...
<body>
	<div class="container">
		...
		<div class="bottomSection">
			<a href="indexRulePage.php"><button>Règles du Forum</button></a>
			<a href="index.php"><button>Accéder au Forum</button></a>
			<a href="indexInfo.php"><button>Équipe du PPE</button></a>
		</div>
	</div>
</body>
</html>